...
public class ExcludeSpecificTotalTimeFlightFilterHelper extends TotalTimeFlightFilterHelper {
    public ExcludeSpecificTotalTimeFlightFilterHelper(int numberOfHours, List<Flight> flights) {
