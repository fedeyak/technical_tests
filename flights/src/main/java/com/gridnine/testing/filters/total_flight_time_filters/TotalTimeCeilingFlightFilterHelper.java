...
public class TotalTimeCeilingFlightFilterHelper extends TotalTimeFlightFilterHelper {
    public TotalTimeCeilingFlightFilterHelper(int numberOfHours, List<Flight> flights) {
