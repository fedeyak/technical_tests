...
public class ExcludeSpecificSegmentAmountFlightFilter extends SegmentAmountFiltersHelper {

    public ExcludeSpecificSegmentAmountFlightFilter(int numberOfSegments, List<Flight> flights) {
