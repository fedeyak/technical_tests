...
public class SpecificTotalTimeFlightFilterHelper extends TotalTimeFlightFilterHelper {
    public SpecificTotalTimeFlightFilterHelper(int numberOfHours, List<Flight> flights) {
