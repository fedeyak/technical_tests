...
public class ExcludeSpecifiedSegmentAmountFlightFilter extends FlightFilter {

    public ExcludeSpecifiedSegmentAmountFlightFilter(int number, List<Flight> flights) {
